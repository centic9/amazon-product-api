...
class AmazonScraper {
    ...
    async startScraper() {
        ...
        //console.log("Having " + this.collector.length + " results");
        return {
    ...
    async saveResultToFile() {
        //console.log("Before saving had " + this.collector.length + " items");
    ...
    sortAndFilterResult() {
        ...
        if (this.scrapeType === 'products') {
            //console.log("Before filtering had " + this.collector.length + " items");
            ...
            //console.log("After filtering had " + this.collector.length + " items");
        }
        if (this.scrapeType === 'products' || this.scrapeType === 'reviews') {
            //console.log("Before filtering2 had " + this.collector.length + " items");
    ...
    async buildRequest(page) {
        //console.log("Using seller: " + this.seller);
            ...
            if (Object.keys(productJsonMeta.colorToAsin).length) {
                for (let item in productJsonMeta.colorToAsin) {
                    ...
                    const variant = {
                        ...
                        images: images,
                        title: item,
                        link: `https://www.amazon.de/dp/${productJsonMeta.colorToAsin[item].asin}/?th=1&psc=1`,
    ...
    grabProduct(body, p) {
        ...
        //console.log("ProduktList: " + productList.length);
        ...
        for (let key in scrapingResult) {
            try {
                ...
                if (ratingSearch) {
                    ...
                    /*console.log("Had1: " + ratingSearch);
                    console.log("Had2: " + ratingSearch.parent);
                    console.log("Had3: " + ratingSearch.parent.parent);
                    console.log("Had4: " + ratingSearch.parent.parent.parent);
                    console.log("Had5: " + ratingSearch.parent.parent.parent.next);
                    console.log("Had6: " + ratingSearch.parent.parent.parent.next.attribs['aria-label']);*/

                    if (ratingSearch.parent.parent.parent.next != null && ratingSearch.parent.parent.parent.next.attribs['aria-label']) {
                ...
                if (titleThumbnailSearch) {
                    //console.log("Key: " + key + ": Thumb: " + titleThumbnailSearch + " - " + titleThumbnailSearch.attribs.alt);
                    scrapingResult[key].title = titleThumbnailSearch.attribs.alt;

                    scrapingResult[key].thumbnail = titleThumbnailSearch.attribs.src;

                    //console.log("Result: " + JSON.stringify(scrapingResult[key]));
                }
            } catch (err) {
                console.log("Had err: " + err + " at " + err.stack);
                continue;
            }
        }


        //console.log("Found " + scrapingResult.length + " items");
        ...
        //console.log("After collecting had " + this.collector.length + " items");
    ...
    validateRating(item) {
        if (this.scrapeType === 'products') {
            //console.log("Had rating: " + item.reviews.rating + ", min: " + this.minRating + ", max: " + this.maxRating);
